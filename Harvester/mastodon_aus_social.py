...
# create a couchdb database called 'mastodon_au_social_final_with_emotion',
# if the database exists,just find that database. If not, just creat the database.
db_name = 'mastodon_au_social_final_with_emotion'
