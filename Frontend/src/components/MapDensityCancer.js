...
// MapDensityCancer component that renders a density map using Echarts
function MapDensityCancer({ mapData }) {
    ...
    useEffect(() => {
        ...
        setOption({
            title: {
                text: 'Cancer Concern by State in Australia (2022)',
...
export default MapDensityCancer;
